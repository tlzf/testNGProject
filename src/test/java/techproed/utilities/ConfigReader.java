...
public class ConfigReader {
    //This class reads the configuration.properties file//configuration properties file i okumak icin bu class
    //Create Properties instance
    private static Properties properties;
    static {
        //path of the configuration file
        String path="configuration.properties"; //bu pathi olusturdugun filedan aliyorsun
        try {

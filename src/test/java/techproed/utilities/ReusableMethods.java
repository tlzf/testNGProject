...
public class ReusableMethods {
    public static String getScreenshot(String name) throws IOException {
        ...
        TakesScreenshot ts = (TakesScreenshot) Driver.getDriver();     //junitde sadece driverdi burda Driver.getdriver
...
//   waitFor(5);  => waits for 5 second => Thread.sleep(5000)
     ...
     * @return
     */
    public static WebElement selectRandomTextFromDropdown(Select select) {     ///bucok kullanilmaz dedi hoca

...
public class Driver {
    ...
    public static WebDriver getDriver(){
        if (driver==null){
            switch (ConfigReader.getProperty("browser")) {     //burada configde browser=chrome dedigimiz icin chrome u seciyor ne yazarsan oraya onu sececek
                case "chrome":
                ...
                case "firefox":
                    ...
                    break;
                case "chrome-headless":  //running in the backround,browser olmadan testi calistiryor,run without browser
                    WebDriverManager.chromedriver().setup();

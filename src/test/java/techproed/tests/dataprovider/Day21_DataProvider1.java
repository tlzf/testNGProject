...
//    DATA PROVIDER METHOD
    @DataProvider(name = "my_smoke_data",parallel = true)    //buraya sadece @DataProvider yazip birakabilirsin ozel isim vermeden
    public Object[][] customerData(){                        //asagida baglanti yaparken ozel ismi vermen lazm ama yoksa normal methodun ismiyle bagla
//    TEST DATA
